...
@REM git push -f https://github.com/Shuaiwen-Cui/OptAlgo.git main
git push -f https://github.com/Shuaiwen-Cui/OptAlgo.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/OptAlgo.git
